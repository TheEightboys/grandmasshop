...
export const notTodaySections: ShowcaseSection[] = [
  ...
  {
    key: "not-today-10",
    eyebrow: "Gambling Impulses",
    title: "NOT TODAY-10",
    subtitle: "Think First. Choose Wisely.",
    description:
      "NOT TODAY Gambling Impulses was created for individuals seeking support while building healthier decision-making habits and maintaining focus on long-term goals.",
    highlights: ["Better Decision-Making", "Focus & Clarity", "Personal Accountability", "Intentional Living"],
...
export const scentSections: ShowcaseSection[] = [
  {
    ...
    description:
      "Aromatic Profile: soft sacred frankincense, exotic floral ylang ylang, and creamy vanilla undertones. Ideal for evening relaxation, prayer, meditation, self-care rituals, bath time, reading, and unwinding after a long day.",
    highlights: ["Grounding", "Sophisticated", "Romantic", "Meditative", "Comforting"],
    images: ["/scent-1.png"],
  },
  {
    key: "scent-2",
    eyebrow: "Bright Botanical Collection",
    title: "Citrus • Magnolia • Lime",
    subtitle: "Fresh citrus opens into soft magnolia petals.",
    description:
      "Aromatic Profile: vibrant lime and sweet orange notes unfold into a clean, uplifting floral-citrus experience. Ideal for morning routines, kitchens, offices, entryways, spring gatherings, and uplifting moods.",
  ...
  },
  {
    ...
    description:
      "Aromatic Profile: spicy clove buds, velvety rose petals, and bright lemon create a fragrance that feels both vintage and timeless. Ideal for dinner parties, guest rooms, intimate gatherings, tea time, and special occasions.",
  ...
  },
  {
    ...
    description:
      "Aromatic Profile: cooling mint awakens the senses while lavender softens the experience and cinnamon adds warmth and depth. Ideal for bedrooms, wellness spaces, yoga studios, massage rooms, evening wind-down routines, and spa environments.",
